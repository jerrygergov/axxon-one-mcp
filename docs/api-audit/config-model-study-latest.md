...
- Started: `2026-05-08T08:20:14.287794+00:00`
- Finished: `2026-05-08T08:20:19.134990+00:00`
...
| --- | --- | ---: | --- |
| PASS | `domain` | 283 | cameras=33 archives=14 components=200 appdata=15 av=30 |
| PASS | `unit_tree` | 204 | total_units=95 top_types=[('AVDetector', 34), ('DeviceIpint', 34), ('AppDataDetector', 16), ('EMailModule', 2)] |
| PASS | `factories` | 170 | requested=14 statuses=[('NOT_FOUND', 7), ('OK', 7)] |
| PASS | `properties` | 2 | representatives=5 |
| PASS | `similar_units` | 613 | samples=3 |
| PASS | `appdata_detectors` | 777 | count=16 factory_options=18 |
