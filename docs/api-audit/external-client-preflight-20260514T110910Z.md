...
- Started: `2026-05-14T11:09:10.188046+00:00`
- Finished: `2026-05-14T11:09:12.350785+00:00`
...
| --- | --- | ---: | --- |
| WARN | `client_http_targets` | 591 | reachable=0 gap=no Axxon Client HTTP API target reachable |
| PASS | `embeddable_host` | 1571 | path=/embedded.html http=200 bytes=856 component=True video=True embed=True gap= |
