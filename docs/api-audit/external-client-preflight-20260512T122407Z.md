...
- Started: `2026-05-12T12:24:07.225346+00:00`
- Finished: `2026-05-12T12:24:07.911856+00:00`
...
| --- | --- | ---: | --- |
| WARN | `client_http_targets` | 213 | reachable=0 gap=no Axxon Client HTTP API target reachable |
| WARN | `embeddable_host` | 472 | http=200 bytes=955 component=False video=False gap=web root does not look like an embeddable component host |
