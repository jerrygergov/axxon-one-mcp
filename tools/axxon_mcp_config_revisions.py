#!/usr/bin/env python3
"""ConfigurationManager read tools for Axxon One MCP (Phase A).
...
chunk/byte/time caps. The backup bytes are never persisted or returned. The destructive
SetRevision / RestoreBackup RPCs are intentionally not exposed here. Direct gRPC against
